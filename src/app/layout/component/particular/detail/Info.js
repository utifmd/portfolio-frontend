const App = ({data}) => {
  let screenshots = data?.screenshot? data.screenshot: []
return (
              ...
              <ul role="listitem" className="border border-gray-300 rounded-md divide-y divide-gray-300">
                ...
                <li className="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                  <div className="w-0 flex-1 flex items-center">
                    ...
                    <span className="ml-2 flex-1 w-0 truncate">source</span>
                  </div>
                  <div className="ml-4 flex-shrink-0">
                    <div onClick={() => {}} className="font-medium text-green-600 hover:text-green-500 cursor-pointer">More</div>
                  </div>
                </li>
              </ul>
            </dd>
